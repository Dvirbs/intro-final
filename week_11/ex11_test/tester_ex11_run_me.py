...
def test_build_tree():
    args_lst = [
        (parse_data(r"data2\tiny_data2.txt"), ["headache", "fever"]),
        (parse_data(r"data2/small_data1.txt"), ["headache", "fever"]),
        (parse_data(r"data2/medium_data1.txt"), ['fever', 'cough']),
        (parse_data(r"data2/medium_data2.txt"), ['fever', 'cough']),
        (parse_data(r"data2\tiny_data3.txt"), [])
    ]
    expected_lst = [
